...
WORKOUT_DATABASE = {
    ...
    "Legs": ["Standing Calf Raise", "Nautilus Glute Drive", "Barbell Hip Thrust", "DB Walking Lunges", "DB Lunges", "Seated Leg Curl", "Lying Leg Curl", "Leg Extension", "Romanian Deadlift", "Linear Leg Extension", "Barbell Squat", "Calf Leg Press"],
